...
export default class TabItem extends Component {
  render() {
    return (
      ...
      <Content style={{width: 200,marginTop:'2%',marginLeft:10,flex:1,height:150,padddingBottom:10}}>
    ...
    position:"absolute",marginLeft:'10%',marginTop:'45%',width:'80%',height:'50%'}}>
              ...
              <Text style={{ marginLeft:'5%',fontWeight:'bold',fontSize:10}}>
              ...
              <Button  transparent  style={{ marginTop:'2%',marginLeft:'3%',fontSize:12}} onPress={() => navigate("Detail")}>
